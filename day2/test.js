...
console.log(challenge.substr(0, 1)); //substr- start, length
console.log(challenge.substring(0, 1)); //substring- start, end
...
console.log(challenge.match(/a/gi)); //g- global, i- case insensitive
